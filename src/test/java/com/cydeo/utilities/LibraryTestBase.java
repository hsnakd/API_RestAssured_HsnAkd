...
public class LibraryTestBase {
    public static RequestSpecification librarianReqSpec;
    public static RequestSpecification studentReqSpec;
    ...
    public static void init(){
      baseURI = ConfigurationReader.getProperty("library_api_url");

        librarianReqSpec = given()
                                .accept(ContentType.JSON)
                                .header("Authorization",getTokenByRole("librarian"))
                                .log().all();
        studentReqSpec =given()
                               .accept(ContentType.JSON)
                                .header("Authorization",getTokenByRole("student"))
                                .log().all();
